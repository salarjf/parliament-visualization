...
var App = function() {
	...
	var scrollToSpecifiedPoint = function() {
		var ttt = 0;
		$('#to-a1').click(function() {
			$('html, body').animate({scrollTop: $('#a1').offset().top - 200}, 400);
			return false;
		});
		$('#to-a2').click(function() {
			$('html, body').animate({scrollTop: $('#a2').offset().top - ttt}, 400);
			return false;
		});
		$('#to-a3').click(function() {
			$('html, body').animate({scrollTop: $('#a3').offset().top - ttt}, 400);
			return false;
		});
		$('#to-a4').click(function() {
			$('html, body').animate({scrollTop: $('#a4').offset().top - ttt}, 400);
			return false;
		});
		$('#to-a5').click(function() {
			$('html, body').animate({scrollTop: $('#a5').offset().top - ttt}, 400);
			return false;
		});
		$('#to-a6').click(function() {
			$('html, body').animate({scrollTop: $('#a6').offset().top - ttt}, 400);
			return false;
		});
		$('#to-a7').click(function() {
			$('html, body').animate({scrollTop: $('#a7').offset().top - ttt}, 400);
			return false;
		});
		
		$('#to-a2-2').click(function() {
			$('html, body').animate({scrollTop: $('#a2').offset().top - ttt}, 400);
			return false;
		});
		$('#to-a3-2').click(function() {
			$('html, body').animate({scrollTop: $('#a3').offset().top - ttt}, 400);
			return false;
		});
		$('#to-a6-2').click(function() {
			$('html, body').animate({scrollTop: $('#a6').offset().top - ttt}, 400);
			return false;
		});
		
		$('#to-a1-m').click(function() {
			$('html, body').animate({scrollTop: $('#a1').offset().top}, 400);
			return false;
		});
		$('#to-a2-m').click(function() {
			$('html, body').animate({scrollTop: $('#a2').offset().top}, 400);
			return false;
		});
		$('#to-a3-m').click(function() {
			$('html, body').animate({scrollTop: $('#a3').offset().top}, 400);
			return false;
		});
		$('#to-a4-m').click(function() {
			$('html, body').animate({scrollTop: $('#a4').offset().top}, 400);
			return false;
		});
		$('#to-a5-m').click(function() {
			$('html, body').animate({scrollTop: $('#a5').offset().top}, 400);
			return false;
		});
		$('#to-a6-m').click(function() {
			$('html, body').animate({scrollTop: $('#a6').offset().top}, 400);
			return false;
		});
		$('#to-a7-m').click(function() {
			$('html, body').animate({scrollTop: $('#a7').offset().top}, 400);
			return false;
		});
    };
